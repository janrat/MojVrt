...
namespace MojVrt
{
    public partial class Form1 : Form
    {
        ...
        private void cb_rastline_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT * FROM rastline WHERE id=" + izbrana_rastlina + ";";
            executeQuery(sql);

            string sql2 = "SELECT * FROM sosedje WHERE rastlina1_id=" + izbrana_rastlina + ";";
            executeQuery2(sql2);
            ...
            label_sajenja.Text = sajenje.Replace("1", " januar").Replace("2", " februar")
                                        .Replace("3", " marec").Replace("4", " april").Replace("5", " maj").Replace("6", " junij")
                                        .Replace("7", " julij").Replace("8", " avgust").Replace("9", " september").Replace("10", " oktober")
                                        .Replace("11", " november").Replace("12", " december");

            label_presajanja.Text = presajanje.Replace("1", " januar").Replace("2", " februar")
                            .Replace("3", " marec").Replace("4", " april").Replace("5", " maj").Replace("6", " junij")
                            .Replace("7", " julij").Replace("8", " avgust").Replace("9", " september").Replace("10", " oktober")
                            .Replace("11", " november").Replace("12", " december");
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            using (WebClient wc = new WebClient())
            {
                ...
                TimeSpan end = new TimeSpan(h2+1, 0, 0); //12 o'clock
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            using (WebClient wc = new WebClient())
            {
                ...
                TimeSpan start = new TimeSpan(h1, 0, 0); //10 o'clock
                TimeSpan end = new TimeSpan(h2 + 1, 0, 0); //12 o'clock
                //TimeSpan start = new TimeSpan(11, 1, 0); //10 o'clock
